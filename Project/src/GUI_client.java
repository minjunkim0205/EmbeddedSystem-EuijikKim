...
public class GUI_client extends JFrame implements CoapClient {
	...
	private void displayRequest(CoapRequest request) {
		if (request.getPayload() != null) {
			display_text.append("Request: " + request.toString() + " payload: "
					+ Encoder.ByteToString(request.getPayload()) + " resource: " + request.getUriPath());
			display_text.setCaretPosition(display_text.getDocument().getLength());
		} else {
	...
	public static void main(String[] args) {
		// ������ ����
		GUI_client gui = new GUI_client("10.50.208.54", CoapConstants.COAP_DEFAULT_PORT);
		// Check ip >> hostname -I
	}
}